...
describe('battle', () => {
    ...
    it('should make Charizard win', () => {
        ...
        expect(battle.getWinner()).toBe(charizard);
    }),
    it('should make Blaziken win', () => {
        const charizard = new Pokemon("Charizard", 100, "fire", [new Move("Ember", "fire", 40)]);
        const blaziken = new Pokemon("Blaziken", 80, "fire",[new Move("Fire Punch", "fire", 75)] ,"Quick Claw");
        ...
        expect(battle.getWinner()).toBe(blaziken);
    })
});